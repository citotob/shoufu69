...
class MenuItem(MPTTModel):
    ...
    parent = TreeForeignKey('self', verbose_name=_('parent menu item'),
                            null=True, blank=True, related_name='children', db_index=True, on_delete=models.CASCADE)
    order = models.PositiveIntegerField(_('order'), default=0, blank=False, null=False)
    category = models.ForeignKey(MenuItemCategory, verbose_name=_('category'), on_delete=models.CASCADE)
