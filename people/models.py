...
class County(models.Model):
    name = models.CharField(_('name'), max_length=255, unique=True)
    state = models.ForeignKey(State, verbose_name=_('state'), related_name='counties', on_delete=models.CASCADE)
...
class City(models.Model):
    ...
    county = models.ForeignKey(County, verbose_name=_('county'), related_name='cities', on_delete=models.CASCADE)
...
class Person(models.Model):
    ...
    address = models.ForeignKey(Address, verbose_name=_('address'), related_name='persons', on_delete=models.CASCADE)
